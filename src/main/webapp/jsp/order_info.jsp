...
<div id="total">
    ...
    <div id="content">
        ...
        <div id="formdiv">
            <fieldset>
                <legend>订单信息</legend>
                <form id="myForm" action="${pageContext.request.contextPath}/orderDetailServlet" method="post">
                <table id="mytable" border="1">
                    ...
                    <c:forEach items="${requestScope.orderList}" var="orders">
                        <tr>
                            ...
                            <td>
                                    ${orders.getCreationTime()}
                            </td>
                            <td>
                                    ${orders.getFinishTime()}
                            </td>
                            <th>
                                <button type="submit" name="myorder" value="${orders.getId()}">查看更多</button>
                            </th>
                        </tr>
                    </c:forEach>
                    <tr>
