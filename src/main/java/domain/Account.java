 ...
 * @date 2018/1/20
 */
public class Account extends Seller {
    /**
     * 主键ID
     */
    private Long id;
     ...
     * @param date1
      */
    public Account(long l, String s, String s1, boolean b, boolean b1, boolean b2, long l1, Long id, long l2, Long sellerId, Date date, Date date1) {
    }
    /**
     * @Title: Account
     * @Description: 构造函数
